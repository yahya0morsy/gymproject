...
function Generator(){
  return(
    <div className='min-w-screen min-h-screen flex flex-col'id="genrev">
      ...
      <img src={img} className=' size-1/3 place-content-center hover:bg-white duration-500 rounded-md hover:translate-x-2 hover:translate-y-2' ></img>
      <div className=' my-20 '>
      <button className='w-20 md:w-24 lg:w-36 mx-1 md:mx-4 border-2 border-blue-400 rounded-md py-2 px-2 blueshadow shadow-lg shadow-blue-700 duration-200'><p className='text-lg md:text-3xl lg:text-4xl'>Tricep</p></button>
      <button className='w-20 md:w-24 lg:w-36 mx-1 md:mx-4 border-2 border-blue-400 rounded-md py-2 px-2 blueshadow shadow-lg shadow-blue-700 duration-200'><p className='text-lg md:text-3xl lg:text-4xl'>Legs</p></button>
      <br/><br/>
      <button className='w-20 md:w-24 lg:w-36 mx-1 md:mx-4 border-2 border-blue-400 rounded-md py-2 px-2 blueshadow shadow-lg shadow-blue-700 duration-200'><p className='text-lg md:text-3xl lg:text-4xl'>Home train</p></button>
      <button className='w-20 md:w-24 lg:w-36 mx-1 md:mx-4 border-2 border-blue-400 rounded-md py-2 px-2 blueshadow shadow-lg shadow-blue-700 duration-200'><p className='text-lg md:text-3xl lg:text-4xl'>Rest</p></button>
      </div>
      </div></div>
